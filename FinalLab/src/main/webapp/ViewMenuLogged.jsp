...
<div class="w3-bar">
	...
	<a class="menu w3-bar-item w3-button w3-hide-small" id="GetGlobalTweets" href=#> Timeline </a>
	<a class="menu w3-bar-item w3-button w3-hide-small" id="GetFollowedUsers" href=#> Buddies </a>
	<a class="menu w3-bar-item w3-button w3-hide-small" id="GetFollowedTweets" href=#> FollowedPosts </a>
